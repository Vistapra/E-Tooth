                    ...
                    <form method="POST" action="{{ route('admin.doctor.update', $doctor) }}"
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                                value="{{ old('name', $doctor->name) }}" required autofocus autocomplete="name" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="spesialis" class="block mt-1 w-full" type="text" name="spesialis"
                                value="{{ old('spesialis', $doctor->spesialis) }}" required autofocus
                        ...
                        <div class="mt-4">
                            ...
                            <img src="{{ Storage::url($doctor->photo) }}" alt="" class="w-[50px] h-[50px] mb-2">
