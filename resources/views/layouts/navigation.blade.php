<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="url('chatify')" :active="request()->routeIs('chatify')">
                        {{ __('Konsultasi & Riwayat') }}
                    </x-nav-link>
                </div>
                @endrole
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.doctor.index')"
                :active="request()->routeIs('admin.doctor.index')">
                {{ __('Doctor') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="url('chatify')" :active="request()->routeIs('chatify')">
                {{ __('Konsultasi & Riwayat') }}
            </x-responsive-nav-link>
            @endrole
